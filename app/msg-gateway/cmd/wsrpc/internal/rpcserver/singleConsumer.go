...
func (s *singleConsumer) HandleMsg(value []byte, key []byte, topic string, partition int32, offset int64, msg *sarama.ConsumerMessage) error {
...
func (s *singleConsumer) PushMsg(ctx context.Context, msgFromMQ *chatpb.PushMsgDataToMQ) error {
